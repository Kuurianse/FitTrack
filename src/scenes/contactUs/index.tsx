...
const ContactUs = ({ setSelectedPage }: Props) => {
  const inputStyles = `mb-5 w-full rounded-lg bg-brown-100
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              onSubmit={onSubmit}
              action="https://formsubmit.co/cd9ff604bcab79d894c9f3ea56957916"
              method="POST"
            >
              <input
              ...
              <button
                type="submit"
                className="mt-5 rounded-lg bg-primary-200 px-20 py-3 transition duration-500 hover:text-red-100"
              >
                SUBMIT
              </button>
            </form>
